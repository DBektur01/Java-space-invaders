...
public class SpaceInvaders extends JFrame implements Commons {
	 ...
	 * Начинать
	 */
	private static final String TOP_MESSAGE = "Космические захватчики <br> Java-версия";
	private static final String INITIAL_MESSAGE = ""
			+ "<br>Инопланетяне пытаются вторгнуться на нашу планету."
			+ "<br><br><br>твоя миссия:"
			+ "<br><br>Убейте всех вторгшихся пришельцев, прежде чем им удастся вторгнуться на планету Земля.."
			+ "<br>И желательно не умирать во время боя!"
			+ "<br><br><br>УДАЧИ!!!";
	/*
	 * Помощь
	 */
	private static final String HELP_TOP_MESSAGE = "Помощь";
	private static final String HELP_MESSAGE = "контролирует: "
							+ "<br><br>Левое движение: <br>Стрелка влево на клавиатуре"
							+ "<br><br>Движение вправо: <br>Клавиатура со стрелкой вправо"
							+ "<br><br>Стрелять: <br>пробел";

	JFrame frame = new JFrame("IAU");
	JFrame frame2 = new JFrame("Space Invaders");
	JFrame frame3 = new JFrame("Помощь");
	...
	public SpaceInvaders() {
		...
		start = new JButton("Начать миссию");
		start.addActionListener(new ButtonListener());
		start.setBounds(800, 800, 200, 100);

		help = new JButton("Помощь");
	...
	private class HelpButton implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			JButton close = new JButton("Закрывать");
