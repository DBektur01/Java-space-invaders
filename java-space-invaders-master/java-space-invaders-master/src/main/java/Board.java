...
public class Board extends JPanel implements Runnable, Commons {
	...
	private String message = "Ваша планета теперь принадлежит нам...";
	...
	public void animationCycle() {
		if (deaths == NUMBER_OF_ALIENS_TO_DESTROY) {
			ingame = false;
			message = "Поздравляем! Вы спасли галактику!";
		}
		...
		while (it.hasNext()) {
			...
			if (alien.isVisible()) {
				...
				if (y > GROUND - ALIEN_HEIGHT) {
					havewon = false;
					ingame = false;
					message = "Инопланетяне вторгаются в галактику!";
				}
